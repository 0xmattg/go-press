...
// mail-sender access for theme-owned notifications, i18n helpers, and
// responsive image helpers. Theme configuration in theme.toml is loaded into
// the content registry by core so themes can declare content
