...
框架同时提供 Provider-neutral 的前台用户、外部身份绑定、可撤销 Session 和注册策略；当前可通过独立 Google OIDC 插件登录，并为后续 MetaMask / SIWE 钱包 Provider 保留统一扩展边界。
...
- **[插件开发](plugins/overview.md)** — 创建插件、内置插件参考（multilang / seo-extras / code-snippets / gopress-analytics）
