...
func init() {
	core.RegisterTheme("terra-trail", func(engine *core.Engine, themeDir string) coreTheme.Theme {
		return New(engine, themeDir)
	})
}

// TerraTrailTheme is a GoPress theme for travel packages, destination guides, and trip planning.
// It embeds BaseTheme to gain runtime engine capabilities (rewrite, template hierarchy, SEO).
type TerraTrailTheme struct {
	coreTheme.BaseTheme
	engine  *core.Engine
	handler *Handler
}
...
var _ coreTheme.Theme = (*TerraTrailTheme)(nil)
var _ coreTheme.DemoDataProvider = (*TerraTrailTheme)(nil)
var _ coreTheme.SettingsProvider = (*TerraTrailTheme)(nil)

// New creates a new TerraTrailTheme.
func New(engine *core.Engine, themeDir string) *TerraTrailTheme {
...
// NewWithDB creates a TerraTrailTheme with only a database connection.
// Useful for testing or standalone usage without a full Engine.
func NewWithDB(db *gorm.DB, themeDir string) *TerraTrailTheme {
...
func (t *TerraTrailTheme) Name() string    { return "TerraTrail" }
func (t *TerraTrailTheme) Version() string { return "1.0.0" }
func (t *TerraTrailTheme) Description() string {
	return "A soft editorial travel theme with destination search, tour packages, transport guides, journals, and CMS demo data."
}
func (t *TerraTrailTheme) Author() string { return "GoPress Team" }

// --- Lifecycle ---

// Setup registers theme runtime hooks and menu locations.
func (t *TerraTrailTheme) Setup(app coreTheme.App) {
	if t.engine == nil {
		return
	}
...
func (t *TerraTrailTheme) ServeHTTP(c *gin.Context) {
	t.BaseTheme.ServeHTTP(c)
}

// --- Templates ---

func (t *TerraTrailTheme) TemplateFuncs() template.FuncMap {
	return t.BaseFuncMap()
}

func (t *TerraTrailTheme) TemplateDir() string {
	return filepath.Join(t.ThemeDir, "templates")
}

func (t *TerraTrailTheme) StaticDir() string {
...
func (t *TerraTrailTheme) DemoSeedPath() string {
...
func (t *TerraTrailTheme) SettingsTemplatePath() string {
