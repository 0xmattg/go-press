...
// Handler processes all front-end HTTP requests for the TerraTrail theme.
type Handler struct {
...
func (h *Handler) LoadPageTemplates(t coreTheme.Theme) error {
	...
	h.templates = bundle
	log.Printf("[terra-trail] Loaded %d page templates", len(bundle))
	return nil
}
...
func (h *Handler) render(c *gin.Context, page string, data interface{}) {
	...
	if err := tmpl.ExecuteTemplate(c.Writer, "base", data); err != nil {
		log.Printf("[terra-trail] Template render error [%s]: %v", page, err)
	}
}
...
func (h *Handler) Home(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting home data: %v", err)
...
func (h *Handler) About(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting about data: %v", err)
		c.String(http.StatusInternalServerError, "Internal server error")
		return
	}
...
func (h *Handler) Products(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting products data: %v", err)
		c.String(http.StatusInternalServerError, "Internal server error")
		return
	}
...
func (h *Handler) Services(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting services data: %v", err)
		c.String(http.StatusInternalServerError, "Internal server error")
		return
	}
...
func (h *Handler) Showcase(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting showcase data: %v", err)
		c.String(http.StatusInternalServerError, "Internal server error")
		return
	}
...
func (h *Handler) Blog(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting blog data: %v", err)
		c.String(http.StatusInternalServerError, "Internal server error")
		return
	}
...
func (h *Handler) Contact(c *gin.Context) {
	...
	if err != nil {
		log.Printf("[terra-trail] Error getting contact data: %v", err)
		c.String(http.StatusInternalServerError, "Internal server error")
		return
	}
