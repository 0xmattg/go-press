...
func init() {
	core.RegisterTheme("atelier-slate", func(engine *core.Engine, themeDir string) coreTheme.Theme {
		return New(engine, themeDir)
	})
}

// AtelierSlateTheme is a GoPress theme for editorial digital studios.
// It embeds BaseTheme to gain runtime engine capabilities (rewrite, template hierarchy, SEO).
type AtelierSlateTheme struct {
	coreTheme.BaseTheme
	engine  *core.Engine
	handler *Handler
}
...
var _ coreTheme.Theme = (*AtelierSlateTheme)(nil)
var _ coreTheme.DemoDataProvider = (*AtelierSlateTheme)(nil)
var _ coreTheme.SettingsProvider = (*AtelierSlateTheme)(nil)

// New creates a new AtelierSlateTheme.
func New(engine *core.Engine, themeDir string) *AtelierSlateTheme {
...
// NewWithDB creates an AtelierSlateTheme with only a database connection.
// Useful for testing or standalone usage without a full Engine.
func NewWithDB(db *gorm.DB, themeDir string) *AtelierSlateTheme {
...
func (t *AtelierSlateTheme) Setup(app coreTheme.App) {
	if t.engine == nil {
		return
	}
...
func (t *AtelierSlateTheme) TemplateFuncs() template.FuncMap {
	return t.BaseFuncMap()
}

func (t *AtelierSlateTheme) TemplateDir() string {
	return filepath.Join(t.ThemeDir, "templates")
}

func (t *AtelierSlateTheme) StaticDir() string {
...
func (t *AtelierSlateTheme) DemoSeedPath() string {
...
func (t *AtelierSlateTheme) SettingsTemplatePath() string {
