...
func registerTranslatableOptions() {
	...
	option.RegisterTranslatable("home_launch_text", "brand", "顶部按钮文字")
	option.RegisterTranslatable("home_nav_1_text", "brand", "导航 1")
	option.RegisterTranslatable("home_nav_2_text", "brand", "导航 2")
	option.RegisterTranslatable("home_nav_3_text", "brand", "导航 3")
	option.RegisterTranslatable("home_nav_4_text", "brand", "导航 4")
	option.RegisterTranslatable("home_nav_5_text", "brand", "导航 5")

	// FloraFi homepage
	option.RegisterTranslatable("home_hero_title", "hero", "Hero 标题")
	option.RegisterTranslatable("home_hero_subtitle", "hero", "Hero 副标题")
	option.RegisterTranslatable("home_hero_btn_text", "hero", "Hero 按钮")
	option.RegisterTranslatable("home_hero_note", "hero", "Hero 小字")
	option.RegisterTranslatable("home_intro_kicker", "intro", "简介标签")
	option.RegisterTranslatable("home_intro_title", "intro", "简介标题")
	option.RegisterTranslatable("home_intro_desc", "intro", "简介描述")
	option.RegisterTranslatable("home_intro_link_text", "intro", "简介链接")
	for _, n := range []string{"1", "2", "3"} {
		option.RegisterTranslatable("home_feature_"+n+"_title", "intro", "功能"+n+" 标题")
		option.RegisterTranslatable("home_feature_"+n+"_desc", "intro", "功能"+n+" 描述")
	}
	option.RegisterTranslatable("home_usecases_kicker", "usecases", "用例标签")
	option.RegisterTranslatable("home_usecases_title", "usecases", "用例标题")
	option.RegisterTranslatable("home_usecases_desc", "usecases", "用例说明")
	for _, n := range []string{"1", "2"} {
		option.RegisterTranslatable("home_usecase_"+n+"_title", "usecases", "用例"+n+" 标题")
		option.RegisterTranslatable("home_usecase_"+n+"_desc", "usecases", "用例"+n+" 描述")
		option.RegisterTranslatable("home_usecase_"+n+"_link", "usecases", "用例"+n+" 链接文字")
	}
	option.RegisterTranslatable("home_cta_btn_text", "cta", "CTA 按钮")
